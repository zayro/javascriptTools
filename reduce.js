...
text_posts = posts.reduce(
  (str, el) => (el.type === "text" ? (str += 1) : str),
  0
);
blog_posts = posts.reduce(
  (str, el) => (el.type === "blog" ? (str += 1) : str),
  0
);
console.log(text_posts); // 3
console.log(blog_posts); // 2
...
console.log(`TCL: : ----------------------`);
console.log(`TCL: : grouped`, grouped);
console.log(`TCL: : ----------------------`);
